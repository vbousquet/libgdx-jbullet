...
public class RotationalLimitMotor {
	...
	public float solveAngularLimits(float timeStep, Vector3 axis, float jacDiagABInv, RigidBody body0, RigidBody body1) {
		...
		Vector3 vel_diff = body0.getAngularVelocity(stack.allocVector3());
		if (body1 != null) {
			vel_diff.sub(body1.getAngularVelocity(stack.allocVector3()));
		}
		...
		motorImp.set(axis).scl(clippedMotorImpulse);
