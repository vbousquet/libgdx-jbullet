...
public class WheelInfo {
	...
	public final Vector3 chassisConnectionPointCS = new Vector3(); // const
	public final Vector3 wheelDirectionCS = new Vector3(); // const
	public final Vector3 wheelAxleCS = new Vector3(); // const or modified by steering
	...
	public void updateWheel (RigidBody chassis, RaycastInfo raycastInfo) {
		if (raycastInfo.isInContact) {
			...
			relpos.set(raycastInfo.contactPointWS).sub(chassis.getCenterOfMassPosition(stack.allocVector3()));
			...
			suspensionRelativeVelocity = 0f;
			raycastInfo.contactNormalWS.set(raycastInfo.wheelDirectionWS).scl(-1);
	...
	public static class RaycastInfo {
		// set by raycaster
		public final Vector3 contactNormalWS = new Vector3(); // contactnormal
		public final Vector3 contactPointWS = new Vector3(); // raycast hitpoint
		public float suspensionLength;
		public final Vector3 hardPointWS = new Vector3(); // raycast starting point
		public final Vector3 wheelDirectionWS = new Vector3(); // direction in worldspace
		public final Vector3 wheelAxleWS = new Vector3(); // axle in worldspace
