...
public class HullDesc {
	...
	/** Array of vertices. */
	public ObjectArrayList<Vector3> vertices;
	...
	public HullDesc(int flag, int vcount, ObjectArrayList<Vector3> vertices) {
		this(flag, vcount, vertices, 3*4);
	}
	
	public HullDesc(int flag, int vcount, ObjectArrayList<Vector3> vertices, int stride) {
		this.flags = flag;
		this.vcount = vcount;
