...
public abstract class VertexData {
	...
	public abstract Vector3 getVertex(int idx, Vector3 out);

	public abstract void setVertex(int idx, float x, float y, float z);

	public void setVertex(int idx, Vector3 t) {
		setVertex(idx, t.x, t.y, t.z);
	}

	public abstract int getIndex(int idx);

	public void getTriangle(int firstIndex, Vector3 scale, Vector3[] triangle) {
		for (int i=0; i<3; i++) {
