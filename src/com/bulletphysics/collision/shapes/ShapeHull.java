...
public class ShapeHull {
	...
	protected ObjectArrayList<Vector3> vertices = new ObjectArrayList<Vector3>();
	protected IntArray indices = new IntArray();
	protected int numIndices;
	protected ConvexShape shape;

	protected ObjectArrayList<Vector3> unitSpherePoints = new ObjectArrayList<Vector3>();
	...
	public ObjectArrayList<Vector3> getVertexPointer() {
		return vertices;
	}

	public IntArray getIndexPointer() {
		return indices;
	}
	...
	private static ObjectArrayList<Vector3> constUnitSpherePoints = new ObjectArrayList<Vector3>();
	
	static {
		constUnitSpherePoints.add(new Vector3(0.000000f, -0.000000f, -1.000000f));
		constUnitSpherePoints.add(new Vector3(0.723608f, -0.525725f, -0.447219f));
		constUnitSpherePoints.add(new Vector3(-0.276388f, -0.850649f, -0.447219f));
		constUnitSpherePoints.add(new Vector3(-0.894426f, -0.000000f, -0.447216f));
		constUnitSpherePoints.add(new Vector3(-0.276388f, 0.850649f, -0.447220f));
		constUnitSpherePoints.add(new Vector3(0.723608f, 0.525725f, -0.447219f));
		constUnitSpherePoints.add(new Vector3(0.276388f, -0.850649f, 0.447220f));
		constUnitSpherePoints.add(new Vector3(-0.723608f, -0.525725f, 0.447219f));
		constUnitSpherePoints.add(new Vector3(-0.723608f, 0.525725f, 0.447219f));
		...
		constUnitSpherePoints.add(new Vector3(0.894426f, 0.000000f, 0.447216f));
		constUnitSpherePoints.add(new Vector3(-0.000000f, 0.000000f, 1.000000f));
		constUnitSpherePoints.add(new Vector3(0.425323f, -0.309011f, -0.850654f));
		constUnitSpherePoints.add(new Vector3(-0.162456f, -0.499995f, -0.850654f));
		constUnitSpherePoints.add(new Vector3(0.262869f, -0.809012f, -0.525738f));
		constUnitSpherePoints.add(new Vector3(0.425323f, 0.309011f, -0.850654f));
		constUnitSpherePoints.add(new Vector3(0.850648f, -0.000000f, -0.525736f));
		constUnitSpherePoints.add(new Vector3(-0.525730f, -0.000000f, -0.850652f));
		constUnitSpherePoints.add(new Vector3(-0.688190f, -0.499997f, -0.525736f));
		constUnitSpherePoints.add(new Vector3(-0.162456f, 0.499995f, -0.850654f));
		constUnitSpherePoints.add(new Vector3(-0.688190f, 0.499997f, -0.525736f));
		constUnitSpherePoints.add(new Vector3(0.262869f, 0.809012f, -0.525738f));
		constUnitSpherePoints.add(new Vector3(0.951058f, 0.309013f, 0.000000f));
		constUnitSpherePoints.add(new Vector3(0.951058f, -0.309013f, 0.000000f));
		constUnitSpherePoints.add(new Vector3(0.587786f, -0.809017f, 0.000000f));
		constUnitSpherePoints.add(new Vector3(0.000000f, -1.000000f, 0.000000f));
		constUnitSpherePoints.add(new Vector3(-0.587786f, -0.809017f, 0.000000f));
		constUnitSpherePoints.add(new Vector3(-0.951058f, -0.309013f, -0.000000f));
		constUnitSpherePoints.add(new Vector3(-0.951058f, 0.309013f, -0.000000f));
		constUnitSpherePoints.add(new Vector3(-0.587786f, 0.809017f, -0.000000f));
