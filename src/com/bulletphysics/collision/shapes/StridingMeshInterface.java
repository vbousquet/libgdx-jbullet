...
public abstract class StridingMeshInterface {
	...
	protected final Vector3 scaling = new Vector3(1f, 1f, 1f);
	...
	public void internalProcessAllTriangles(InternalTriangleIndexCallback callback, Vector3 aabbMin, Vector3 aabbMax) {
		...
		Vector3[] triangle/*[3]*/ = new Vector3[]{ stack.allocVector3(), stack.allocVector3(), stack.allocVector3() };

		Vector3 meshScaling = getScaling(stack.allocVector3());
	...
	private static class AabbCalculationCallback extends InternalTriangleIndexCallback {
		public final Vector3 aabbMin = new Vector3(1e30f, 1e30f, 1e30f);
		public final Vector3 aabbMax = new Vector3(-1e30f, -1e30f, -1e30f);
	...
	public Vector3 getScaling(Vector3 out) {
		out.set(scaling);
		return out;
	}
