...
public abstract class SimplexSolverInterface {
	...
	public abstract void addVertex(Vector3 w, Vector3 p, Vector3 q);
	
	public abstract boolean closest(Vector3 v);

	public abstract float maxVertex();

	public abstract boolean fullSimplex();

	public abstract int getSimplex(Vector3[] pBuf, Vector3[] qBuf, Vector3[] yBuf);

	public abstract boolean inSimplex(Vector3 w);
	
	public abstract void backup_closest(Vector3 v);

	public abstract boolean emptySimplex();

	public abstract void compute_points(Vector3 p1, Vector3 p2);
